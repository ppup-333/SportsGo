...
@Component
public class AdminResultValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		int statusValue = Integer.parseInt(users.getStatusCode().getStatusCode());

		if ("".equals(inputAct) && "".equals(inputName) && "".equals(inputId) && cityValue == 00
				&& districtValue == 1000 && statusValue == 00) {
			errors.rejectValue("account", "", "請輸入搜尋條件");
		}
